# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-11-27 10:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('monkey', '0004_auto_20171126_1123'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Account', verbose_name='回答者')),
            ],
        ),
        migrations.CreateModel(
            name='AnswerComment',
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Account', verbose_name='评论者')),
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Answer')),
                ('reply_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='monkey.AnswerComment', verbose_name='基于评论的评论')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Account')),
            ],
        ),
        migrations.CreateModel(
            name='City',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Account', verbose_name='会员名')),
                ...
                ('p_node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='monkey.Comment', verbose_name='父级评论')),
            ],
        ),
        migrations.CreateModel(
            name='Coupon',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='monkey.Account', verbose_name='使用者')),
                ('coupon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Coupon')),
            ],
        ),
        migrations.CreateModel(
            name='CourseChapter',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.CourseDetail')),
            ],
            options={
                'verbose_name': '课程大纲',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursesections', to='monkey.CourseChapter')),
            ],
            options={
                'verbose_name': '课时目录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teachers', models.ManyToManyField(to='monkey.Teacher', verbose_name='课程讲师')),
            ],
            options={
                'verbose_name': '学位课程',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Account')),
                ('degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.DegreeCourse')),
                ('mentor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_students', to='monkey.Account', verbose_name='导师')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.CourseChapter')),
            ],
            options={
                'verbose_name': '家庭作业',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Homework')),
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_stu_homework_record', to='monkey.Account', verbose_name='导师')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.EnrolledDegreeCourse', verbose_name='学生')),
            ],
        ),
        migrations.CreateModel(
            name='Industry',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentors', models.ManyToManyField(to='monkey.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, help_text='不填用户的话代表给未注册用户发通知', null=True, on_delete=django.db.models.deletion.CASCADE, to='monkey.Account')),
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.CharField(blank=True, max_length=255, null=True)),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Order')),
            ],
        ),
        migrations.CreateModel(
            name='PricePolicy',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Industry')),
            ],
            options={
                'verbose_name': '职位信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Account', verbose_name='提问者')),
                ('course_section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='monkey.CourseSection')),
                ('degree_course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='monkey.DegreeCourse')),
            ],
        ),
        migrations.CreateModel(
            name='Scholarship',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Account', verbose_name='被执行人')),
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment_path', models.CharField(blank=True, help_text='跟进记录的截图等', max_length=128, null=True, verbose_name='附件路径')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('enrolled_degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.EnrolledDegreeCourse', verbose_name='学生')),
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mentor', to='monkey.Account', verbose_name='导师')),
            ],
        ),
        migrations.CreateModel(
            name='Tags',
        ...
        migrations.AddField(
            ...
            name='course_module',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Course', verbose_name='学位模块'),
        ),
        migrations.AddField(
            model_name='studyrecord',
            name='enrolled_degree_course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.EnrolledDegreeCourse'),
        ),
        ...
        migrations.AddField(
            ...
            name='score_rule',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.ScoreRule', verbose_name='关联规则'),
        ),
        migrations.AddField(
            model_name='enrolleddegreecourse',
            name='order_detail',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='monkey.OrderDetail'),
        ),
        migrations.AddField(
            model_name='enrolledcourse',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Course'),
        ),
        migrations.AddField(
            model_name='enrolledcourse',
            name='order_detail',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='monkey.EnrolledDegreeCourse'),
        ),
        migrations.AddField(
            model_name='degreecoursereview',
            name='course',
            field=models.ForeignKey(blank=True, help_text='不填写即代表评价整个学位课程', null=True, on_delete=django.db.models.deletion.CASCADE, to='monkey.Course', verbose_name='评价学位模块'),
        ),
        migrations.AddField(
            model_name='degreecoursereview',
        ...
        migrations.AddField(
            model_name='degreecoursereview',
            name='tags',
            field=models.ManyToManyField(blank=True, to='monkey.Tags', verbose_name='标签'),
        ),
        migrations.AddField(
            model_name='courseschedule',
            name='homework',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Homework'),
        ),
        migrations.AddField(
            model_name='courseschedule',
            name='study_record',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.StudyRecord'),
        ),
        migrations.AddField(
            model_name='coursereview',
            name='enrolled_course',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='monkey.EnrolledCourse'),
        ),
        migrations.AddField(
            model_name='coursereview',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursechapters', to='monkey.Course'),
        ),
        migrations.AddField(
            model_name='couponrecord',
            name='order',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='monkey.Order', verbose_name='关联订单'),
        ),
        migrations.AddField(
            model_name='city',
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Province'),
        ),
        migrations.AddField(
            model_name='bulletscreen',
            name='course_section',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.CourseSection'),
        ),
        migrations.AddField(
            model_name='article',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.ArticleSource', verbose_name='来源'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
        ...
        migrations.AddField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monkey.Question', verbose_name='问题'),
        ),
        migrations.AddField(
            model_name='course',
            name='degree_course',
            field=models.ForeignKey(blank=True, help_text='若是学位课程，此处关联学位表', null=True, on_delete=django.db.models.deletion.CASCADE, to='monkey.DegreeCourse'),
        ),
        migrations.AlterUniqueTogether(
            name='studyrecord',
